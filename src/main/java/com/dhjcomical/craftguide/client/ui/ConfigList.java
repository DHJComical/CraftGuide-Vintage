...
import com.dhjcomical.craftguide.client.ui.text.TextSource;
import com.dhjcomical.craftguide.client.ui.text.TextSource.TextChangeListener;
import com.dhjcomical.craftguide.client.ui.text.TranslatedTextSource;
import com.dhjcomical.craftguide.dump.HTMLExport;
import com.dhjcomical.craftguide.dump.JsonRecipeDump;
import com.dhjcomical.gui_craftguide.components.GuiElement;
import com.dhjcomical.gui_craftguide.minecraft.MultilineText;
		...
		addButton("craftguide.gui.config.export_displayed_recipes", "craftguide.gui.config.export_displayed_recipes.button", buttonTemplate,
				new IButtonListener()
				{
					...
					public void onButtonEvent(GuiButton button, Event event)
					{
						if(event == Event.PRESS)
						{
                            try(FileOutputStream output = new FileOutputStream(new File(Minecraft.getMinecraft().gameDir, "CraftGuide_DisplayedRecipes.json")))
							{
		...
		addButton("craftguide.gui.config.export_crafting_recipes", "craftguide.gui.config.export_crafting_recipes.button", buttonTemplate,
				new IButtonListener()
				{
					...
					public void onButtonEvent(GuiButton button, Event event)
					{
						if(event == Event.PRESS)
						{
							try(FileOutputStream output = new FileOutputStream(new File(Minecraft.getMinecraft().gameDir, "CraftGuide_CraftingRecipes.json")))
							{
