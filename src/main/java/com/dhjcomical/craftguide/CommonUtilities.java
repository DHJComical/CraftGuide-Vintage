...
public class CommonUtilities
{
	...
	public static int countItemNames(ItemStack item)
	{
		if(getItemDamage(item) == CraftGuide.DAMAGE_WILDCARD && item.getHasSubtypes())
		{
            ...
            item.getItem().getSubItems(item.getItem().getCreativeTab(), temp);
			return temp.size();
		}
		else
		{
	...
	private static List<String> cachedExtendedItemStackText(ItemStack stack)
	{
		...
		{
			CraftGuideLog.log("exception trace: com.dhjcomical.craftguide.CommonUtilities.cachedExtendedItemStackText item " + (stack != null? stack.getClass() : "null"));
	...
	public static List<String> getExtendedItemStackText(Object item)
	{
		...
		{
			CraftGuideLog.log("exception trace: com.dhjcomical.craftguide.CommonUtilities.getExtendedItemStackText item " + (item != null? item.getClass() : "null"));
			throw new RuntimeException(e);
		}
	}
	...
	private static void appendStackInfo(List<String> text, ItemStack stack)
	{
		...
		{
			CraftGuideLog.log("exception trace: com.dhjcomical.craftguide.CommonUtilities.appendStackInfo stack " + (stack != null? stack.getClass() : "null"));
			throw new RuntimeException(e);
		}
	}
	...
	public static boolean searchExtendedItemStackText(Object item, String text)
	{
		...
		{
			CraftGuideLog.log("exception trace: com.dhjcomical.craftguide.CommonUtilities.searchExtendedItemStackText item " + (item != null? item.getClass() : "null"));
			throw new RuntimeException(e);
		}
	}
	...
	private static List<String> getItemStackText(Object item)
	{
		...
		{
			CraftGuideLog.log("exception trace: com.dhjcomical.craftguide.CommonUtilities.getItemStackText item " + (item != null? item.getClass() : "null"));
			throw new RuntimeException(e);
		}
	}
