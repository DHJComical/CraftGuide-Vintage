package com.dhjcomical.craftguide.dump;
...
public abstract class RecipeDump
{
	...
	{
		writeStringValue("item_name", "item", stack.getItem().getTranslationKey());
		writeStringValue("int", "damage", Integer.toString(stack.getItemDamage()));
        writeStringValue("int", "size", Integer.toString(stack.getCount()));
