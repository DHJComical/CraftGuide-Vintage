...
public class CraftGuide
{
	...
	public void init()
	{
		try
		{
			Class.forName("com.dhjcomical.craftguide.recipes.DefaultRecipeProvider").newInstance();
			Class.forName("com.dhjcomical.craftguide.recipes.BrewingRecipes").newInstance();
			Class.forName("com.dhjcomical.craftguide.recipes.GrassSeedDrops").newInstance();
		}
		...
		loadModRecipes("BTW", "com.dhjcomical.craftguide.recipes.BTWRecipes");
		addIC2Recipes();
		loadModRecipes("gregtech", "com.dhjcomical.craftguide.recipes.GregTechRecipes");
		loadModRecipes("extendedWorkbench", "com.dhjcomical.craftguide.recipes.ExtendedWorkbench");
		loadModRecipes("BuildCraft|Factory", "com.dhjcomical.craftguide.recipes.BuildCraftRecipes");
	...
	private void addIC2Recipes()
	{
		try
		{
			...
			loadModRecipes("IC2", "com.dhjcomical.craftguide.recipes.IC2ExperimentalRecipes");
		}
		catch(ClassNotFoundException e)
		{
			loadModRecipes("IC2", "com.dhjcomical.craftguide.recipes.IC2Recipes");
		}
	}
