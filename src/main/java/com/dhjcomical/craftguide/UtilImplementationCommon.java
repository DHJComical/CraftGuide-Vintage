...
import com.dhjcomical.craftguide.filters.EmptyOreDictionaryFilter;
import com.dhjcomical.craftguide.filters.MultipleItemFilter;
import com.dhjcomical.craftguide.filters.NoItemFilter;
import com.dhjcomical.craftguide.filters.SingleItemFilter;
import com.dhjcomical.craftguide.filters.StringItemFilter;
			...
			for(Object o: list)
			{
				if(o instanceof String)
				{
					if(first)
					{
						...
						text.add(rarity.color + (String)o);
